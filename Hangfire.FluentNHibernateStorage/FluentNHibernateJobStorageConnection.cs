...
namespace Hangfire.FluentNHibernateStorage
{
    public class FluentNHibernateJobStorageConnection : JobStorageConnection
    {
            ...
            TimeSpan expireIn)
        {
            ...
            var serializedInvocationData = SerializationHelper.Serialize(invocationData);
            Logger.TraceFormat("CreateExpiredJob={0}", serializedInvocationData);
            ...
            return Storage.UseSession(session =>
            {
                using (var transaction = session.BeginTransaction())
                {
                    ...
                    {
                        InvocationData = serializedInvocationData,
